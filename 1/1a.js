...
// data.forEach((string) => {
//   const matches = string.match(regex1); // creates array from matches
//   const val = Number(`${matches[0]}${matches[matches.length - 1]}`);
//   res += val;
// });
...
//     matches[0] = stringToNum[matches[0]];
//   }
//   if (matches[last].length > 1) {
//     matches[last] = stringToNum[matches[last]];
//   }
